...
static void prv_inbox_received_handler(DictionaryIterator *iter, void *context) {
  ...
  if(interval_t) { 
    ...
    //APP_LOG(APP_LOG_LEVEL_INFO, "Interval: %d", weather_interval);
...
static void main_window_load(Window *window) {
	...
	// Day
	day_layer = text_layer_create(GRect( PBL_IF_ROUND_ELSE(25, 0), PBL_IF_ROUND_ELSE(137, 137), 72, 25));
	...
	// Temperature
	temperature_layer = text_layer_create(GRect(PBL_IF_ROUND_ELSE(84, 72), PBL_IF_ROUND_ELSE(137, 137), 72, 25));
	...
	// Battery
	text_battery_layer = text_layer_create(GRect(PBL_IF_ROUND_ELSE(84, 72), PBL_IF_ROUND_ELSE(137, 137), 72, 25));
	text_layer_set_background_color(text_battery_layer, GColorClear);
	text_layer_set_text_color(text_battery_layer, GColorWhite);
	text_layer_set_text_alignment(text_battery_layer, GTextAlignmentCenter);
	
	// Bluetooth
	text_bluetooth_layer = text_layer_create(GRect( PBL_IF_ROUND_ELSE(25, 0), PBL_IF_ROUND_ELSE(137, 137), 72, 25));
